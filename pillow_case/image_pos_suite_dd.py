...
def template_match(file_name, img_target: bytes = None, background_bytes: bytes = None):
    ...
    target_2 = cv.resize(target, (350, 175))
    background_2 = cv.resize(background, (61, 61))
    ...
    right_down = (int(max_loc[0]) + 60, int(max_loc[1]) + 60)
...
if __name__ == '__main__':
    ...
    target_img = './verify_image.jpeg'
    template_img = './verify_image_slide.jpeg'
